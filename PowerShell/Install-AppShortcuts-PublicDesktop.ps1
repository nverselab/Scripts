$Array = @(
    ...
    @{Target="C:\Program Files\Microsoft Office\root\Office16\OUTLOOK.EXE";ShortcutPath="$env:Public\Desktop\Outlook.lnk"}) | % { New-Object object | Add-Member -NotePropertyMembers $_ -PassThru }
